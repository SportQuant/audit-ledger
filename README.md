...
Ledger records follow a deterministic, matchweek-partitioned structure by sport/league, season year, and matchweek:
...
│   └── 2026/
│       ├── mw05/
│       │   ├── 2026-09-18-brentford-vs-chelsea.json
│       │   └── ...
│       └── ...
├── CHANGELOG.md
├── LEDGER_README.md
...
## 📄 Ledger Record Schemas (WORM v1.1)

### Phase 1: Pre-Kickoff Blind Commitment (`COMMITTED`)

Pushed to GitHub at **T-48h**. Contains strictly zero model probabilities or market data:

```json
{
  "status": "COMMITTED",
  "commit_utc": "2026-09-16T19:00:00.104291+00:00",
...
```json
{
  "status": "REVEALED",
  "commit_utc": "2026-09-16T19:00:00.104291+00:00",
  "revealed_utc": "2026-09-18T21:05:14.882103+00:00",
  "sha256_hash": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",
  "canonical_payload": {
    "match_id": "epl_2026_brentford_chelsea",
    "market": "1X2",
    "home_team": "Brentford",
    "away_team": "Chelsea",
    ...
    "model_telemetry": {
      "physics_anchor": 0.3200,
      "ml_ensemble": 0.3100,
      "entropy_score": 0.9840,
      "dynamic_alpha": 0.0500
    }
  },
  "settlement": {
    "actual_result": "AWAY",
